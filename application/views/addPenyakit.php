            ...
            <div class="col-md-8">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
					...
					<a href="<?php echo base_url() ?>penyakitListing"><i class="fa fa-backward"></i>Back to Listing Penyakit</a><br/>
                        <h3 class="box-title">Enter Penyakit Details</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    <?php $this->load->helper("form"); ?>
                    <form role="form" id="addUser" action="<?php echo base_url() ?>addNewPenyakit" method="post" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">                                
                                    <div class="form-group">
                                        <label for="diagnosa">Penyakit</label>
                                        <input type="text" class="form-control required" value="<?php echo set_value('penyakit'); ?>" id="penyakit" name="penyakit" maxlength="128">
                                    </div>
                                    
                                </div>
                                <div class="col-md-6">                                
                                    <div class="form-group">
                                        <label for="diagnosa">Deskripsi</label>
                                        <textarea class="form-control required" id="deskripsi" name="deskripsi" maxlength="128">
										<?php echo set_value('penyakit'); ?></textarea>
                                    </div>
                               ...
                               <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="email"><?php echo "Diagnosa ".($i+1);?></label>
										<select name="<?php echo "diagnosa".($i+1);?>" id="<?php echo "diagnosa".($i+1);?>" class="form-control required">
										<?php
											echo "<option value='0'>[--Pilih--]</option>";
										for($j=0;$j<count($diagnosa);$j++)
										{
											echo "<option value='".$diagnosa[$j]->id."'>".$diagnosa[$j]->gejala." pada ".$diagnosa[$j]->bagian."</option>";
										}
										?>
										</select>
                                    </div>
...
<script src="<?php echo base_url(); ?>assets/js/addBagian.js" type="text/javascript"></script>