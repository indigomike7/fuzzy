            ...
            <div class="col-md-8">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
					...
					<a href="<?php echo base_url() ?>diagnosaListing"><i class="fa fa-backward"></i>Back to Listing Diagnosa</a><br/>
                        <h3 class="box-title">Enter Diagnosa Details</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    <?php $this->load->helper("form"); ?>
                    <form role="form" id="addUser" action="<?php echo base_url() ?>addNewDiagnosa" method="post" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">                                
                                    <div class="form-group">
                                        <label for="diagnosa">Diagnosa</label>
                                        <input type="text" class="form-control required" value="<?php echo set_value('gejala'); ?>" id="gejala" name="gejala" maxlength="128">
                                    </div>
                               ...
                               <div class="col-md-6">
                                    <div class="form-group">
										...
										{
											echo "<option value='".$bagian[$i]->id."'>".$bagian[$i]->bagian."</option>";
										}
										?>
										</select>
                                    </div>
