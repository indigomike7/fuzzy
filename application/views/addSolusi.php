            ...
            <div class="col-md-8">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
					...
					<a href="<?php echo base_url() ?>solusiListing"><i class="fa fa-backward"></i>Back to Listing Solusi</a><br/>
                        <h3 class="box-title">Enter Solusi Details</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    <?php $this->load->helper("form"); ?>
                    <form role="form" id="addUser" action="<?php echo base_url() ?>addNewSolusi" method="post" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">                                
                                    <div class="form-group">
                                        <label for="diagnosa">Deksripsi</label>
                               ...
                               <div class="col-md-6">
                                    <div class="form-group">
										...
										{
											echo "<option value='".$penyakit[$i]->id."'>".$penyakit[$i]->penyakit."</option>";
										}
										?>
										</select>
                                    </div>
