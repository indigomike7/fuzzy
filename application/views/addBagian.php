<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-users"></i> Bagian Tanaman Management
        <small>Add / Edit Bagian</small>
      </h1>
    </section>
            ...
            <div class="col-md-8">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
					<a href="<?php echo base_url() ?>bagianListing"><i class="fa fa-backward"></i>Back to Listing Bagian Tanaman</a>
                    <div class="box-header">
                        <h3 class="box-title">Enter Bagian Tanaman Details</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    <?php $this->load->helper("form"); ?>
                    <form role="form" id="addUser" action="<?php echo base_url() ?>addNewBagian" method="post" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">                                
                                    <div class="form-group">
                                        <label for="fname">Bagian</label>
                                        <input type="text" class="form-control required" value="<?php echo set_value('bagian'); ?>" id="bagian" name="bagian" maxlength="128">
                                    </div>
